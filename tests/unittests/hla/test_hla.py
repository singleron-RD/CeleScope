...
from celescope.hla.mapping_hla import hla_typing, read_index, split_bam, summary
from celescope.tools.utils import get_barcode_from_match_dir
...
class testHLA(unittest.TestCase):
    def setUp(self):
        ...
        self.match_dir = (
            "/SGRNJ01/RD_dir/pipeline_test/zhouyiqi/HLA/test_0908/match_dir/"
        )
        self.barcodes, _ncell = get_barcode_from_match_dir(self.match_dir)
        self.thread = 6
