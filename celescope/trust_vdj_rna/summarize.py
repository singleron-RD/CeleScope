...
class Summarize(Step):
    ...
    def process(self):
        ...
        df_all = pd.merge(df_merge, df_all, on='barcode',how='outer')
        ...
        df_all = df_all[['barcode', 'is_cell', 'contig_id', 'high_confidence', 'length', 'chain', 'v_gene', 'd_gene', 'j_gene', 'c_gene', 'full_length', 'productive', 'cdr3', 'cdr3_nt', 'reads', 'umis', 'clonotype_id']]
        ...
        df_all.to_csv(f'{self.outdir}/{self.sample}_all_contig.csv', sep=',', index=False)
